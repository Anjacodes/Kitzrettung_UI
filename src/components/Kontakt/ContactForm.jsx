...
function ContactForm() {
  ...
  return (
    <form className="text-center flex flex-col text-base items-center w-full my-48" action="https://formspree.io/f/mdojkowl" method="POST">
      ...
      <p className='w-1/2 lg:w-1/3 mb-5'>Wir bearbeiten jede Anfrage persönlich. Daher kann es bis zu 48 Stunden dauern, bis du von uns hörst. Danke für dein Verständnis!</p>
      <p className='mb-20'>Gerne erreichst du uns auch telefonisch unter 0151 742 549 53.</p>
