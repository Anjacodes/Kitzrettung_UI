...
const WorkObject = {
    title: "UNSERE ARBEIT",
    paragraphs: [
        <>Unser eingetragener Verein hat es sich gemäß seiner Satzung zur Aufgabe gemacht das Tierleid, das durch den Einsatz landwirtschaftlicher Maschinen entsteht, möglichst zu verhindern (siehe <a href={Satzung} className="text-second hover:underline" target="_blank" rel="noreferrer">Satzung</a>). Wir setzen dabei auf den Einsatz von Drohnen mit hochauflösender Wärmebildtechnik (s. <NavLink to="/technik" className='text-second hover:underline'>Technik</NavLink>). Dabei werden die zu mähenden Wiesen, möglichst am Morgen des Mähtermins, beflogen. Die Wärmebildkameras detektieren dabei die in den Wiesen liegenden Tiere als Wärmequelle. Je nach Gelände und Temperatur sind bis zu 2 ha in 30 Minuten abgeflogen. Die Temperatur spielt hierbei eine besondere Rolle. Je größer die Temperaturdifferenz zwischen Tierkörper und Umgebung, desto einfacher gelingt das Auffinden. Daher ist ein Einsatz dieser Technik in den frühen Morgenstunden zu bevorzugen. Dies ermöglicht zudem eine größere Flughöhe, was eine höhere Hektarleistung ermöglicht.</>,
