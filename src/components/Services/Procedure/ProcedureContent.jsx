  ...
  return (
    ...
    <div className='mt-12 lg:flex'>
     ...
     <div className='lg:ml-12 text-base text-justify text-slate-600 my-4'>
        ...
        <p className="mb-6">WICHTIG: Sofern Landwirte unsere Leistungen abrufen, ist ausnahmslos die Zustimmung des zuständigen Jagdausübungsberechtigten erforderlich (siehe LEISTUNGEN-RECHTLICHES).</p>
