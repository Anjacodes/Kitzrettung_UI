    ...
    <div className="mx-20 my-48 lg:mx-52">
      ...
      <div className='mt-12 lg:flex'>
        ...
        <div className='lg:ml-12 text-base text-justify text-slate-600 my-4 lg:w-2/3'>
          ...
          <p className="mb-6">Für den zuständigen Jagdausübungsberechtigten kommt zwar aufgrund der Hegepflicht nach <a href="https://www.gesetze-im-internet.de/bjagdg/__1.html" target="_blank" rel="noreferrer" className='hover:underline hover:cursor-pointer'>§ 1 Bundesjagdgesetz</a> eine Mitwirkungspflicht in Betracht, eine alleinige Verantwortung hat er, auch wenn er durch den Landwirt über den Mähtermin informiert wird, nicht. Zur Hege gemäß Bundesjagdgesetz sind im Übrigen auch die Grundeigentümer der Flächen verpflichtet, da diesen per Gesetz das Jagdrecht auf seinen Flächen zusteht.</p>
      ...
      <div className='lg:flex mt-12 h-full'>
        ...
        <p className="mb-6">Da das Finden von Wild mittels Drohnen und das anschließende Aufsuchen und Bergen von z. B. Rehkitzen auch zum Nachstellen von Wild gehört, erfüllt dies, sofern fremdes Jagdrecht verletzt wird, den Tatbestand der Jagdwilderei nach <a href="https://www.gesetze-im-internet.de/stgb/__292.html" target="_blank" rel="noreferrer" className='hover:cursor-pointer hover:underline'>§ 292 Strafgesetzbuch</a>.</p>
